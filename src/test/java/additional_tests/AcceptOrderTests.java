...
public class AcceptOrderTests {
    ...
    @After
    public void clear() {
        if (responseAcceptOrder.statusCode() == SC_OK){
            // Удаление курьера
    ...
    public void acceptOrder() {
        ...
        // Принять заказ
        responseAcceptOrder = client.CourierClient.sendPutRequestV1OrdersAcceptWithOrderId(orderId, courierId);
    ...
    public void acceptOrderWithoutCourierIdReturnNotEnoughDataToSearch() {
        responseAcceptOrder = client.CourierClient.sendPutRequestV1OrdersAcceptWithoutCourierId(ORDER_ID_62489);
    ...
    public void acceptOrderReturnNoCourierWithThisId() {
        responseAcceptOrder = client.CourierClient.sendPutRequestV1OrdersAcceptWithOrderId(ORDER_ID_62489, COURIER_ID_0);
    ...
    public void acceptOrderWithoutOrderIdReturnNotEnoughDataToSearch() {
        ...
        responseAcceptOrder = client.CourierClient.sendPutRequestV1OrdersAcceptWithoutOrderId(courierId);
        checkStatusCodeAndErrorMessage(responseAcceptOrder, SC_BAD_REQUEST, NOT_ENOUGH_DATA_TO_SEARCH);
    }
    ...
    public void acceptOrderWithInvalidOrderIdReturnNotEnoughDataToSearch() {
        ...
        LoginResponse loginResponse = deserializationResponseLoginCourier(responseLoginCourier); // получаем id курьера из ответа
        int courierId = loginResponse.getId();
        responseAcceptOrder = client.CourierClient.sendPutRequestV1OrdersAcceptWithOrderId(ORDER_ID_0, courierId);
